...
export const metadata: Metadata = {
  ...
  description:
    "Transform your team collaboration with CollaborativeX's AI-powered whiteboard featuring real-time collaboration, video calling, and smart drawing assistance.",
  keywords:
    "collaborative whiteboard, AI whiteboard, real-time collaboration, video calling, team collaboration, remote teams, digital whiteboard",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: "CollaborativeX",
              description:
                "AI-powered real-time collaborative whiteboard platform with integrated video calling",
