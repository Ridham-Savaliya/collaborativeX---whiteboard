...
import { Download, FileImage, Undo, Redo, Clock, Mic, Shapes, Video, FileText, Settings } from 'lucide-react';
      ...
      {showUpgradeModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-[#962aef] rounded-xl p-6 max-w-md w-full mx-4">
            ...
            <p className="mb-4">This is a premium feature. Subscribe for just $5/month to access:</p>
